...
describe('userService', () => {
  ...
  it('getUsers should return a user list', async () => {
    const mockData = [{ id: '1', name: 'Andy', email: 'andy@email.com' }];
  ...
  it('getUserById should return a user', async () => {
    const mockUser = { id: '1', name: 'Andy', email: 'andy@email.com' };
    mockedFetch.mockResolvedValueOnce({
      ok: true,
      json: async () => mockUser,
    });
  ...
  it('createUser should create a user', async () => {
    const input = { name: 'Andy', email: 'andy@email.com' };
    mockedFetch.mockResolvedValueOnce({
      ok: true,
  ...
  it('updateUser should update a user', async () => {
    const input = { id: '1', name: 'Andy Atualizado', email: 'novo@email.com' };
    mockedFetch.mockResolvedValueOnce({
      ok: true,
      json: async () => input,
    });
